...
const AnamnesisForm: React.FC = () => {
  ...
  if (submitted) {
    ...
    return (
      <div className="bg-brand-50 p-6 sm:p-10 rounded-xl shadow-lg border border-brand-200 text-center animate-fade-in">
        ...
        <h3 className="text-xl sm:text-2xl font-serif text-brand-800 mb-4">Ficha Enviada com Sucesso</h3>
